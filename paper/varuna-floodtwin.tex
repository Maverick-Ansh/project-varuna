...
free tiers (Colab/Kaggle GPUs to build, CPU to serve). We report three findings. \textbf{(1) An
...
(\rupee850 vs \rupee1{,}309 per m$^3$ removed in Patna). Code, artifacts, and the live dashboard are public.
\end{abstract}
